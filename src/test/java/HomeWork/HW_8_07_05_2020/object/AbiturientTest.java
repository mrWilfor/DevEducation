...
class AbiturientTest {
    ...
    void createAbiturientTest() {
        ...
        assertEquals(expAssessments, a1.getAssessments());
    }
    ...
    void setGetAbiturientTest() {
        ...
        assertEquals(expAssessments, a.getAssessments());
    }
    ...
    void testToString() {
        ...
        String expected = "HomeWork.HW_8_07_05_2020.object.Abiturient@596129863[id=324, surName=Sidorova, name=Dariya, " +
