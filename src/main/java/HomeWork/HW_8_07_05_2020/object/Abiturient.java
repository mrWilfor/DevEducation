...
public class Abiturient {
    ...
    public Abiturient(long id, String surName, String name, String middleName, String address, long phoneNumber, String assessments) {
        this.id = id;
    ...
    public boolean equals(Object o) {
        if (o == this) {
            ...
            return this.id == ((Abiturient) o).id && this.surName.equals(((Abiturient) o).surName) &&
                    ...
                    this.assessments.equals(((Abiturient) o).assessments);
        }
        return false;
    }
    ...
    public int hashCode() {
        return (int) (31 * id + (surName != null ? surName.hashCode() : 0) + (name != null ? name.hashCode() : 0) +
                ...
                phoneNumber + (assessments != null ? assessments.hashCode(): 0));
    }
    ...
    public String toString() {
        ...
        string.add("id=".concat(Long.toString(id)))
                ...
                .add("assessments=".concat(assessments));
